/* CODIGO RECEPTOR V46 - FIX MOVIMIENTO PAD (CORREGIDO) */
...
String getHtml() {
  ...
  // Función corregida: encodeURI para manejar espacios
  ...
  // G-PAD (CORREGIDO: comandos con ; y movimientos seguros)
  ...
  h += "<div></div><button class='btn-gray' onclick=\"c('/cmd?gcode=G91;G1 Y10 F3000')\">⬆️ Y+10</button><div></div>";
  h += "<button class='btn-gray' onclick=\"c('/cmd?gcode=G91;G1 X-10 F3000')\">⬅️ X-10</button>";
  h += "<button class='btn-blue' onclick=\"c('/cmd?gcode=G90')\">🎯 ABS</button>";
  h += "<button class='btn-gray' onclick=\"c('/cmd?gcode=G91;G1 X10 F3000')\">➡️ X+10</button>";
  h += "<div></div><button class='btn-gray' onclick=\"c('/cmd?gcode=G91;G1 Y-10 F3000')\">⬇️ Y-10</button><div></div>";
  h += "</div>";
  h += "<div style='margin-top:10px'><button class='btn-gray' onclick=\"c('/cmd?gcode=G91;G1 Z5 F600')\">⏫ Z+5</button><button class='btn-gray' onclick=\"c('/cmd?gcode=G91;G1 Z-5 F600')\">⏬ Z-5</button></div></div>";
  // CONTROL
