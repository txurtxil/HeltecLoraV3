/* CODIGO RECEPTOR V40 - FIX PIN VEXT 36 */
...
#define SCL_OLED 18
#define RST_OLED 21
#define Vext 36      // <--- ¡CORREGIDO!
#define LED_PIN 35   // LED Blanco
// ------------------------
...
void setup() {
    ...
    // --- FIX PANTALLA ---
    pinMode(Vext, OUTPUT);
    digitalWrite(Vext, LOW); delay(500); // <--- POWER ON CORRECTO
